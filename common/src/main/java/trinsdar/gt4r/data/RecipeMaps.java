...
public class RecipeMaps {
    ...
    public static RecipeMap<?> FLUID_EXTRACTOR_COILS = AntimatterAPI.register(RecipeMap.class, new RecipeMap<>(Ref.ID, "fluid_extractor_coils", new RecipeBuilder())).setIcon(GT4RData.CupronickelHeatingCoil);
